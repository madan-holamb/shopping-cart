...
public class WebSocketVerticle extends AbstractVerticle {
	...
	ProductRepoServiceImpl productRepoService;
	
	public WebSocketVerticle(ProductService service,ProductRepoServiceImpl productRepoService) {
	...
	private void handleWebSocket(ServerWebSocket webSocket) {
		...
		webSocket.textMessageHandler(message -> {
			try {
				...
				Map<String, Object> webSocketResponseMessageMap = new ProductUtility().webSocketRequestMessage(newUserId,message,service,productRepoService);
